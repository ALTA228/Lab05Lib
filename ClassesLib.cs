    ...
    public class ClassesLib
    {
        class Town
        {
            ...
            static void Main(string[] args)
            {
                ...
                Console.Write("Введiть назву мiста: "); string sCity = Console.ReadLine();

                Console.Write("Введiть назву континента: "); string sName = Console.ReadLine();
                ...
                Console.Write("Чи є у країна порт? (y-так, n-нi): "); ConsoleKeyInfo keyHasPort =

                Console.ReadKey(); Console.WriteLine();

                Console.Write("Чи є у країна аеропорт? (y-так, n-нi): "); ConsoleKeyInfo
                ...
                Console.WriteLine("Назва міста: " + OurTown.City);
